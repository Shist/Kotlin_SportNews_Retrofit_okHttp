...
// 6) Сделать сортировку новостей при перезагрузке (внутри map можно сделать SortBy... по дате), добавить поле даты (раскоментить в Json-овском айтеме)
// 6.2)* Посмотреть миграции базы данных
// 7)* Создать отдельную таблицу для одного item и загружать оттуда
